...
#ifndef AESGCMNOPADDING_SWIFT_H
#define AESGCMNOPADDING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AesGcmNoPadding",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AesGcmNoPaddingAlgorith (SWIFT_EXTENSION(AesGcmNoPadding))
- (NSString * _Nullable)decryptUsingPublicKeyWithEncryptedFileData:(NSData * _Nonnull)encryptedFileData publicKeyData:(NSData * _Nonnull)publicKeyData error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)encryptUsingPublicKeyWithFileDataToEncrypt:(NSData * _Nonnull)fileDataToEncrypt publicKeyData:(NSData * _Nonnull)publicKeyData error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)getMd5ForRequest:(NSString * _Nonnull)requestForMD5 SWIFT_WARN_UNUSED_RESULT;
@end
